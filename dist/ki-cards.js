...
(function (KI) {
  ...
  window.KI.define("ki-bursdag-card", KiBursdagCard);
  KI.register("ki-bursdag-card", "KI Bursdag", "Bursdager: kommende og hele året, fra Birthdays-sensorer");
})(window.KI);
} catch (e) { console.error("ki-cards: 35-ki-bursdag-card feilet", e); }
...
if (!customElements.get("ki-natt-card")) window.KI.define("ki-natt-card", KiNattCard);
...
if (!customElements.get("ki-natt-card-editor")) window.KI.define("ki-natt-card-editor", KiNattCardEditor);
...
} catch (e) { console.error("ki-cards: 36-ki-natt-card feilet", e); }
...
if (!customElements.get("ki-sensor-card")) window.KI.define("ki-sensor-card", KiSensorCard);
...
if (!customElements.get("ki-sensor-card-editor")) window.KI.define("ki-sensor-card-editor", KiSensorCardEditor);
...
} catch (e) { console.error("ki-cards: 51-ki-rom-tile-card feilet", e); }
...
(() => {
  ...
  if (!customElements.get('ki-hjem-editor')) window.KI.define('ki-hjem-editor', KiHjemEditor);
  if (!customElements.get('ki-hjem-card')) window.KI.define('ki-hjem-card', KiHjemCard);
  window.customCards = window.customCards || [];
...
} catch (e) { console.error("ki-cards: 52-ki-hjem-card feilet", e); }
...
(() => {
  ...
  const start = (LitElement) => {
    ...
    window.KI.define("ki-basseng-card", KiBassengCard);
    window.KI.define("ki-basseng-card-editor", KiBassengCardEditor);
