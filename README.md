...
| <img src="https://raw.githubusercontent.com/SebastianKristo/ki-cards/main/brand/ki-strom-detaljer-card.svg" width="28" align="absmiddle"> | `ki-strom-detaljer-card` | KI Strøm-detaljer | Fem kompakte detaljkort valgt med `vis:`: strømregning, effekttrinn, effektledd per måned (trykkbare søyler), Norgespris spart og spotpris mot Norgespris. Alle sensorene har standardverdier og kan overstyres under `sensorer:` |
